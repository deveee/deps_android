...
[ ! -d irrlicht-src ] && \
	git clone --depth 1 -b SFML https://github.com/deveee/Irrlicht irrlicht-src

cd irrlicht-src/source/Irrlicht/Android-SFML

export SFML_PATH="$OUTPUT_PATH/sfml/"
...
cp -r ../../../lib/Android-SFML/$TARGET_ABI/libIrrlicht.a ../../../../../output/irrlicht/lib/$TARGET_ABI/libIrrlicht.a
# update shaders
